...
/******************************************
 ...
 DROP TABLE dbo.Cliente_PkSequencial
 DROP TABLE dbo.Cliente_PkCPF
...
CREATE TABLE dbo.Cliente_PkCPF (
	...
	DataAniversario date not null,
	Obs char(3000) not null,
	CONSTRAINT pk_Cliente_PkCPF PRIMARY KEY (CPF)
)
go
